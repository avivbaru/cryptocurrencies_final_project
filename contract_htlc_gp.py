...
class Contract_HTLC_GP(Contract_HTLC):
    def __init__(self, amount_in_msat: int, hash_image: int, expiration_block_number: int,
                 attached_channel: cm.Channel,
                 owner1: 'ln.LightningNode', owner2: 'ln.LightningNode', penalty: int):
        super().__init__(amount_in_msat, hash_image, expiration_block_number, attached_channel, owner1, owner2)
